...
<body class="body">
  <div class="card text-center">
    ...
    <div class="card-body">
      <div class="logo"><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
       ...
       v23.252C158.782,264.139,176.552,235.688,176.552,203.034z" />
          ...
          <g>
            ...
            <path style="fill:#FFFFFF;"
              d="M113.885,238.345H62.667c-10.231,0-18.529,7.962-18.529,17.788v23.27
       ...
       v23.252C370.644,149.38,388.414,120.929,388.414,88.276z" />
          <g>
            ...
            <path style="fill:#FFFFFF;"
              d="M325.747,123.586h-51.218c-10.231,0-18.529,7.962-18.529,17.788v23.27
       ...
       v23.252C485.402,378.898,503.172,350.446,503.172,317.793z" />
          <g>
            ...
            <path style="fill:#FFFFFF;"
              d="M440.505,353.103h-51.218c-10.231,0-18.529,7.962-18.529,17.788v23.27
       ...
       v23.252C273.54,484.829,291.31,456.377,291.31,423.724z" />
          <g>
            ...
            <path style="fill:#FFFFFF;"
              d="M228.643,459.034h-51.218c-10.231,0-18.529,7.962-18.529,17.788v23.27
      ...
      <div class="yuhu">
        <a href="<?php echo site_url('home/daftar'); ?>" class="btn btn-primary btn-block"><i class="fas fa-user-plus"> Daftar</i></a>
        <a href="<?php echo site_url('home/cek'); ?>" class="btn btn-primary btn-block"><i class="fas fa-user-cog"> Cek</i></a>
      </div>
    </div>
    <div class="card-footer text-muted">
      Made with <i style="color: #DD352E;" class="fas fa-heart"></i> by
      <a style="cursor:pointer" data-toggle="modal" data-target="#exampleModalCenter"><i class="fas fa-users"></i></a>
    </div>
  </div>
  <!-- Modal -->
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">Nama Kelompok</h5>
        ...
        <div class="modal-body">
          <table class="table table-hover">
            ...
            <tbody>
              <tr>
                <td>Moh Ravi Dwi Putra</td>
                <td>1461800115</td>
              </tr>
              <tr>
                <td>Ryannov R Simbolon</td>
                <td>1461800120</td>
              </tr>
              <tr>
                <td>Dilarida Alrizeki</td>
                <td colspan="2">1461800143</td>
              </tr>
              <tr>
                <td>Abdurrahman Hanif</td>
                <td colspan="2">1461800175</td>
              </tr>
            </tbody>
          </table>
        </div>
